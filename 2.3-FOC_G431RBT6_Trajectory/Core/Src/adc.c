...
void HAL_ADCEx_InjectedConvCpltCallback(ADC_HandleTypeDef *hadc)
{
  if (hadc->Instance == ADC2)
  {
    ...
    if (count_speed == 0)
    {
      ...
      _motor_speed = diff_angle * freq_speed / 14;
    ...
    if (run_state)
    {
      ...
      frame.data[0] = motor_i_q / MAX_CURRENT;
      frame.data[1] = motor_control_context.torque_norm_q;
      // frame.data[0] = encoder_angle;
      // frame.data[1] = -(motor_i_u + motor_i_w);
